...
<!-- CSS-Only Hamburger Menu Controls -->
	...
	<div class="sidebar" id="sidebar">
		...
		<nav class="sidebar-tabs">
			<ul>
				...
				<li><a href="/list/dashboard/" class="<?php if (in_array($TAB, ["DASHBOARD"])) echo "active"; ?>"><i class="fas fa-gauge"></i> <span class="sidebar-label"><?= _("Dashboard") ?></span></a></li>
					...
					<ul class="sidebar-submenu">
						<li>
							<a href="/add/web/">
								...
								<span class="sidebar-label"><?= _("Add Web") ?></span>
							</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sidebar-submenu">
						<li>
							<a href="/add/dns/">
								<i class="fas fa-plus"></i> 
								<span class="sidebar-label"><?= _("Add DNS") ?></span>
							</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sidebar-submenu">
						<li>
							<a href="/add/mail/">
								<i class="fas fa-plus"></i> 
								<span class="sidebar-label"><?= _("Add Mail") ?></span>
							</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sidebar-submenu">
						<li>
							<a href="/add/db/">
								<i class="fas fa-plus"></i> 
								<span class="sidebar-label"><?= _("Add Database") ?></span>
							</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sidebar-submenu">
						<li>
							<a href="/add/cron/">
								<i class="fas fa-plus"></i> 
								<span class="sidebar-label"><?= _("Add Cron") ?></span>
							</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sidebar-submenu">
						<li>
							<a href="/add/backup/">
								<i class="fas fa-plus"></i> 
								<span class="sidebar-label"><?= _("Add Backup") ?></span>
							</a>
						</li>
					</ul>
				</li>
